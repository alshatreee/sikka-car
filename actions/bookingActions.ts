    ...
    booking = await prisma.$transaction(async (tx) => {
      ...
      return tx.booking.create({
        data: {
          ...
          civilIdImageFront: data.civilIdImageFront || undefined,
          civilIdImageBack: data.civilIdImageBack || undefined,
          licenseImageFront: data.licenseImageFront || undefined,
          licenseImageBack: data.licenseImageBack || undefined,
          totalDays,
          totalAmount,
          notes: data.notes,
